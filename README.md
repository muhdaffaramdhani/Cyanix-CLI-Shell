...
Cyanix-CLI-Shell (CyanSh) adalah implementasi **custom shell interaktif** yang dikembangkan sebagai representasi antarmuka baris perintah (_command line interface_) untuk konsep sistem operasi **Cyanix OS** berbasis microkernel.
